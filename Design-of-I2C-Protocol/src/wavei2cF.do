...
add wave -noupdate -expand -group i2c_waveformate -color White /i2c_testbench/i2c_sda
add wave -noupdate -expand -group i2c_waveformate -color White /i2c_testbench/i2c_scl
...
WaveRestoreCursors {{Cursor 1} {199720 ps} 0}
...
update
WaveRestoreZoom {116010 ps} {258550 ps}
